          ...
          <div className='my-8 m-3'>
            ...
            <div className='mt-3'>
              <p className='flex gap-3'>
                <span>
                  <span className='underline text-muted-foreground'>Posts</span> {community._count.Post}</span>
                <span>
                  <span className='underline text-muted-foreground'>Members</span> {community._count.Membership}</span>
              </p>
            </div>
          </div>
          <div className='m-3'>
