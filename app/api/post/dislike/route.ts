...
export const POST = async (req: NextRequest) => {
  try {
    ...
    if (!like) {
      return NextResponse.json({ message: "You already disliked this post" }, { status: STATUS_CODES.SUCCESS })
    }
    ...
    return NextResponse.json({ message: "Post disliked successfully" }, { status: STATUS_CODES.SUCCESS })
  } catch (error) {
...
export type DislikePostAPIResponse = APIResponse<ReturnType<typeof POST>>
